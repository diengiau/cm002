...
```{r}
#| echo: true
m1 = lm(female ~ read + write + math + science, data=Hsb)
summary(m1)
```
...
-   You can find research topics by yourself and do your own statistical analysis:
...
-   Next lectures focus on how to make good reporting results to audience
